    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      <div className="flex-1 p-4 md:p-6 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 neon-text mt-12 md:mt-0">Dashboard</h1>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-4 md:space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                {/* Income vs Expenses */}
                <div className="col-span-1 lg:col-span-2 glass rounded-lg p-4 neon-border">
                  <h3 className="text-lg md:text-xl font-medium mb-3 md:mb-4 flex items-center">
          ...
          {activeTab !== 'overview' && (
            <div className="glass rounded-lg p-4 md:p-6 neon-border">
              <h2 className="text-xl md:text-2xl font-bold mb-4 neon-text">
